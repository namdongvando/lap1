...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 07, 2022 at 02:08 PM
...
('44bc0a10-295c-46c5-92fd-a789d76d8808', 'CK', 'CK', '', 'thuonghieu'),
('2fd5538b-9c89-4ca0-b048-0395ba7ee5be', 'Guchi', 'GC', 'asas', 'thuonghieu'),
('6b96698c-0517-4937-9484-20fe4d60c8b7', 'Bittis', 'BT', '', 'thuonghieu'),
('a97edc79-07c7-482d-b65d-82f3c7b63194', 'Hàng Mới', '1', 'Hàng mới nhập', 'tinhtrangsp'),
('8cb8e156-7314-46a0-8e3c-50cfd72a9673', 'Mới 99%', '2', 'Sản Phẩm mới 99', 'tinhtrangsp');
...
('16fa2b9d-238c-4ba0-ac23-59f9cbd29d37', '', 'Easy Polo Black Edition', 'http://lap1.dev1:8080/', 'http://lap1.dev1:8080/', 'http://lap1.dev1:8080/', '44bc0a10-295c-46c5-92fd-a789d76d8808', 'easy-polo-black-edition', 'admin', '200000.0000', '0.0000', '', '', '/public/userfiles/admin/images/product10.jpg', NULL, 0, NULL, 0, 0, 1, 0, 'vi'),
...
('9ad93796-eb47-4c7e-bb2d-64b1c3e50257', NULL, 'Áo Thun 1', 'Áo Thun 1', 'Áo Thun 1', 'Áo Thun 1', '44bc0a10-295c-46c5-92fd-a789d76d8808', 'ao-thun-1', 'admin', '500000.0000', '0.0000', '', '&lt;p&gt;Mo tao sản phẩm&lt;/p&gt;\r\n\r\n&lt;p&gt;&amp;nbsp;&lt;/p&gt;\r\n\r\n&lt;p&gt;&lt;img alt=&quot;&quot; src=&quot;/public/userfiles/admin/images/product12.jpg&quot; style=&quot;height:249px; width:268px&quot; /&gt;&lt;/p&gt;', '/public/userfiles/admin/images/product12.jpg', NULL, 0, NULL, 0, 0, 1, 0, 'vi'),
...
INSERT INTO `lap1_sanpham_donhang` (`Id`, `Code`, `TinhTrang`, `SDT`, `Email`, `HoTen`, `NgayTao`, `NgayGiaoHang`, `TongTien`, `SoSP`, `TinhThanh`, `QuanHuyen`, `PhuongXa`, `DiaChiChiTiet`, `GhiChu`) VALUES
('726f7e83-bc1f-4317-a599-847b036fc629', 'DH-2022-01-2', 0, '23423423423', NULL, 'asdasda sdasdas', '2022-01-03 20:48:41', '2022-01-05 20:48:41', '900000', 3, 32, 33, NULL, 'asdasdasd', 'asdasdas'),
('c9d38dca-5665-4360-8613-b05c919af35f', 'DH-2022-01-1', -1, '0123456789', NULL, 'asdasda sdasdas', '2022-01-03 20:46:31', '2022-01-07 00:00:00', '900000', 3, 32, 33, NULL, 'asdasdasd', 'asdasda'),
('8a101dff-3f1c-4e0d-b79c-c8c41c0dcb4e', 'DH-31641385009', 3, '0123456789', NULL, 'asdasda sdasdas', '2022-01-05 19:16:49', '2022-01-08 00:00:00', '200000', 1, 32, 33, NULL, 'asdasdasd', 'asdasdas'),
('9fd2e1c4-36ee-4887-836d-9245786b0afc', 'DH-2022-01-4', 0, '23423423423', NULL, 'asdasda sdasdas', '2022-01-03 20:50:55', '2022-01-05 20:50:55', '600000', 1, 32, 33, NULL, 'asdasdasd', 'ASDasdas');
...
('fbf2de70-4136-4ce4-9ae2-94f0b8c3152f', '8a101dff-3f1c-4e0d-b79c-c8c41c0dcb4e', '0240658b-010b-4b8f-bbf7-54ffe3e7a4ae', 1, '200000');

-- --------------------------------------------------------

--
-- Table structure for table `lap1_sanpham_donhang_log`
--

DROP TABLE IF EXISTS `lap1_sanpham_donhang_log`;
CREATE TABLE IF NOT EXISTS `lap1_sanpham_donhang_log` (
  `Id` varchar(50) NOT NULL,
  `Name` text NOT NULL,
...
--
-- Dumping data for table `lap1_sanpham_donhang_log`
--

INSERT INTO `lap1_sanpham_donhang_log` (`Id`, `Name`, `TinhTrang`, `NgayTao`) VALUES
('65891971-906d-4422-a033-ee70b910c576', 'Dang giao hàng', '1', '2022-01-05 20:24:20'),
('f66a4920-b2c2-4a05-b1ee-7be411d9f302', 'Dang giao hàng', '1', '2022-01-05 20:25:05'),
('f3db8c2f-455b-45ce-8522-c017c42be654', 'asdas das', '1', '2022-01-05 20:25:49'),
('c14094ce-5321-4734-97ef-5e9d0788859f', 'Khach da nhan hang', '2', '2022-01-05 20:26:17'),
('74155de4-4df2-486f-b10e-8dab888832f8', 'Khach da nhan hang', '2', '2022-01-05 20:26:57'),
('f3b41031-9da7-481b-bfe0-afe4322266b1', 'as dasdas', '1', '2022-01-05 20:27:03'),
('b72f709c-9f9d-49ca-b688-808384bad343', 'asdasda', '2', '2022-01-05 20:27:11'),
('cef78e89-7039-48dc-906c-dc6d9fda19f0', 'ad asdasda', '3', '2022-01-05 20:27:22'),
('557a71ec-a88b-46ee-ae75-f46ffd404143', 'asda sdas', '1', '2022-01-05 20:31:03'),
('09a683f9-f9fa-439c-8fe8-ae8718c40d29', 'asdasdas', '2', '2022-01-05 20:31:09'),
('8eb8c4e4-5c0e-40c4-aa18-7389032ca93b', 'asdasdas', '2', '2022-01-05 20:31:58'),
('26c42f19-f60f-4837-b9e9-4c2a4b3b57fa', 'asdasdas', '2', '2022-01-05 20:32:14'),
('f4afdba0-5b29-4042-aed5-973889da1ffd', 'as asdasd', '3', '2022-01-05 20:32:19'),
('9cd3d207-b997-4006-9f64-44fda6749f83', 'as asdasd', '3', '2022-01-05 20:34:10'),
('ce2044cd-2c20-4a72-9266-c889c6f3083c', 'asdas', '2', '2022-01-05 20:34:16'),
('ac46aef5-6d90-4ed0-846e-7cf8869b17b0', 'asdasdas', '1', '2022-01-05 20:34:20'),
('aff6af72-3a65-451d-8730-d3097c2a8915', 'asdfasdas', '1', '2022-01-05 20:34:29'),
('c4a1aaf4-8d5e-46fe-8af3-6f123c313156', 'asdfasdas', '1', '2022-01-05 20:34:47'),
('b33548d9-df50-4c49-bb75-6b535e780c44', 'asdasa', '-1', '2022-01-05 20:34:53'),
('eda8d2d9-7233-4981-b74a-f5a734ba0b6b', 'asdasa', '-1', '2022-01-05 20:36:45'),
('9121d341-83f1-4b86-b52a-02bc44124aa8', 'assdasd', '1', '2022-01-05 20:37:11'),
('cbb670a6-4fdc-4018-9ce1-c23731e1ff50', 'asdasdas', '3', '2022-01-05 20:37:17'),
('2d7d0c28-cfc7-4c69-9f98-32782b388551', 'asdasdas', '3', '2022-01-05 20:37:41'),
('d7179a98-ed61-4f5a-8c1e-74b08e42b9d3', 'asdasdas', '3', '2022-01-05 20:38:03'),
('30b1dee7-d9fe-448c-9ebc-f8cfd64c648d', 'asdasdas', '2', '2022-01-05 20:39:17'),
('740b5b3e-795e-4e0f-8690-358c51ad165a', 'asdasdas', '-1', '2022-01-05 20:39:26'),
('43980e80-2e31-40d4-a2af-b9f908caae48', 'asdasdas', '-1', '2022-01-05 20:40:24'),
('01623efc-a32d-4b7b-add5-87ea4c7ea1c0', 'asdasdas', '-1', '2022-01-05 20:40:38');

-- --------------------------------------------------------

--
-- Table structure for table `lap1_sanpham_infor`
--

DROP TABLE IF EXISTS `lap1_sanpham_infor`;
CREATE TABLE IF NOT EXISTS `lap1_sanpham_infor` (
  `Id` varchar(50) NOT NULL,
  ...
  `IdSanPham` varchar(50) NOT NULL,
  PRIMARY KEY (`Id`),
  UNIQUE KEY `Keyword` (`Keyword`,`IdSanPham`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `lap1_sanpham_infor`
--

INSERT INTO `lap1_sanpham_infor` (`Id`, `Keyword`, `Val`, `Des`, `IdSanPham`) VALUES
('abdf', 'ThuongHieu', 'GC', 'Thương Hiệu', '0240658b-010b-4b8f-bbf7-54ffe3e7a4ae'),
('9df104ab-fdc9-4d47-b210-7b749430f98f', 'TinhTrang', '1', '', '0240658b-010b-4b8f-bbf7-54ffe3e7a4ae'),
('578d1265-b352-4251-a9c7-c68268a03a2c', 'ThuongHieu', 'CK', '', '9ad93796-eb47-4c7e-bb2d-64b1c3e50257'),
('d896145f-b2d3-4f30-a46b-4ba060ebdb61', 'TinhTrang', '1', '', '9ad93796-eb47-4c7e-bb2d-64b1c3e50257'),
('894bdb03-7c37-4482-9a56-4613877441d8', 'Tag', 'Ao Thu, Áo Tết', '', '0240658b-010b-4b8f-bbf7-54ffe3e7a4ae');
